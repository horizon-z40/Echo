...
export const tests: Test[] = [
  ...
  {
    id: 'test-philosophy-personality',
    title: '哲学人格测试',
    slug: 'philosophy-personality',
    description: '探索你的哲学人格底色：你是理性的建构者，还是灵性的逍遥客？基于四个哲学维度，揭示你认识世界、存在行动、价值归属和世界底色的独特取向。',
    shortDescription: '发现你的哲学人格类型，探索你的人生底色',
    categoryId: 'cat-1',
    questionCount: 16,
    estimatedMinutes: 6,
    tags: ['人格', '哲学', '深度'],
    completionCount: 56789,
    isPopular: true,
    isFeatured: true,
    coverGradient: 'from-slate-700 via-purple-800 to-indigo-900',
...
export const decisionQuestions = [
  ...
  {
    id: 'dec-q3', testId: 'test-decision', order: 3,
    text: '当你做出的决定产生不好的结果时，你会...',
    options: [
      { id: 'dec-q3-a', text: '快速调整方向', scores: { INTUITIVE: 2, SPONTANEOUS: 1 } },
      { id: 'dec-q3-b', text: '分析原因，总结经验', scores: { ANALYTICAL: 3 } },
      { id: 'dec-q3-c', text: '寻求他人建议来弥补', scores: { CONSULTATIVE: 2, DEPENDENT: 1 } },
      { id: 'dec-q3-d', text: '后悔当初不应该做决定', scores: { AVOIDANT: 2 } },
    ],
  },
  {
    id: 'dec-q4', testId: 'test-decision', order: 4,
    text: '面对两个看起来差不多的选择，你会...',
    options: [
      { id: 'dec-q4-a', text: '跟随内心的选择', scores: { INTUITIVE: 3 } },
      { id: 'dec-q4-b', text: '列出优缺点仔细比较', scores: { ANALYTICAL: 3, DELIBERATE: 1 } },
      { id: 'dec-q4-c', text: '询问信任的人的看法', scores: { CONSULTATIVE: 3 } },
      { id: 'dec-q4-d', text: '希望有人能替我决定', scores: { DEPENDENT: 2, AVOIDANT: 1 } },
    ],
  },
  {
    id: 'dec-q5', testId: 'test-decision', order: 5,
    text: '你认为一个好的决策应该是...',
    options: [
      { id: 'dec-q5-a', text: '及时行动，把握时机', scores: { INTUITIVE: 2, SPONTANEOUS: 1 } },
      { id: 'dec-q5-b', text: '经过充分分析和验证', scores: { ANALYTICAL: 3 } },
      { id: 'dec-q5-c', text: '让相关人员都参与进来', scores: { CONSULTATIVE: 3 } },
      { id: 'dec-q5-d', text: '尽量避免出错', scores: { AVOIDANT: 2, DELIBERATE: 1 } },
    ],
  },
  {
    id: 'dec-q6', testId: 'test-decision', order: 6,
    text: '在做重大决定前，你通常会...',
    options: [
      { id: 'dec-q6-a', text: '相信第一感觉', scores: { INTUITIVE: 3 } },
      { id: 'dec-q6-b', text: '花时间研究各种可能性', scores: { ANALYTICAL: 3, DELIBERATE: 1 } },
      { id: 'dec-q6-c', text: '和身边的人讨论', scores: { CONSULTATIVE: 3 } },
      { id: 'dec-q6-d', text: '拖延到最后一刻', scores: { AVOIDANT: 3 } },
    ],
  },
  {
    id: 'dec-q7', testId: 'test-decision', order: 7,
    text: '当时间紧迫需要快速决定时，你会...',
    options: [
      { id: 'dec-q7-a', text: '果断做出决定', scores: { INTUITIVE: 2, SPONTANEOUS: 1 } },
      { id: 'dec-q7-b', text: '快速收集关键信息后决定', scores: { ANALYTICAL: 2 } },
      { id: 'dec-q7-c', text: '联系最信任的人征求意见', scores: { CONSULTATIVE: 2, DEPENDENT: 1 } },
      { id: 'dec-q7-d', text: '感到焦虑，希望有人能帮我', scores: { AVOIDANT: 2, DEPENDENT: 1 } },
    ],
  },
  {
    id: 'dec-q8', testId: 'test-decision', order: 8,
    text: '你认为决策过程中，哪种因素最重要？',
    options: [
      { id: 'dec-q8-a', text: '直觉和创造力', scores: { INTUITIVE: 3 } },
      { id: 'dec-q8-b', text: '逻辑和事实', scores: { ANALYTICAL: 3 } },
      { id: 'dec-q8-c', text: '团队共识', scores: { CONSULTATIVE: 3 } },
      { id: 'dec-q8-d', text: '风险最小化', scores: { AVOIDANT: 2, DELIBERATE: 1 } },
    ],
  },
  {
    id: 'dec-q9', testId: 'test-decision', order: 9,
    text: '当你的决定被他人质疑时，你会...',
    options: [
      { id: 'dec-q9-a', text: '坚持自己的判断', scores: { INTUITIVE: 2 } },
      { id: 'dec-q9-b', text: '用数据和逻辑解释原因', scores: { ANALYTICAL: 3 } },
      { id: 'dec-q9-c', text: '倾听他们的意见，必要时调整', scores: { CONSULTATIVE: 2 } },
      { id: 'dec-q9-d', text: '开始怀疑自己的决定', scores: { DEPENDENT: 2, AVOIDANT: 1 } },
    ],
  },
  {
    id: 'dec-q10', testId: 'test-decision', order: 10,
    text: '面对一个没有标准答案的问题，你会...',
    options: [
      { id: 'dec-q10-a', text: '选择感觉最对的方案', scores: { INTUITIVE: 3 } },
      { id: 'dec-q10-b', text: '分析各种可能的结果', scores: { ANALYTICAL: 2, DELIBERATE: 1 } },
      { id: 'dec-q10-c', text: '参考类似情况的处理方式', scores: { CONSULTATIVE: 2 } },
      { id: 'dec-q10-d', text: '希望有明确的规则可以遵循', scores: { DEPENDENT: 2, AVOIDANT: 1 } },
    ],
  },
  {
    id: 'dec-q11', testId: 'test-decision', order: 11,
    text: '你觉得做决定这件事本身...',
    options: [
      { id: 'dec-q11-a', text: '是一种冒险和探索', scores: { INTUITIVE: 2, SPONTANEOUS: 1 } },
      { id: 'dec-q11-b', text: '是一个需要认真对待的过程', scores: { ANALYTICAL: 2, DELIBERATE: 1 } },
      { id: 'dec-q11-c', text: '可以与他人一起完成', scores: { CONSULTATIVE: 2 } },
      { id: 'dec-q11-d', text: '让我感到压力和不安', scores: { AVOIDANT: 3 } },
    ],
  },
  {
    id: 'dec-q12', testId: 'test-decision', order: 12,
    text: '当需要改变原有计划时，你会...',
    options: [
      { id: 'dec-q12-a', text: '快速适应新情况', scores: { INTUITIVE: 2, SPONTANEOUS: 1 } },
      { id: 'dec-q12-b', text: '重新评估所有选项', scores: { ANALYTICAL: 2, DELIBERATE: 1 } },
      { id: 'dec-q12-c', text: '与相关人员沟通协调', scores: { CONSULTATIVE: 3 } },
      { id: 'dec-q12-d', text: '感到困扰，希望维持原状', scores: { AVOIDANT: 2 } },
    ],
  },
  {
    id: 'dec-q13', testId: 'test-decision', order: 13,
    text: '在团队决策中，你更倾向于...',
    options: [
      { id: 'dec-q13-a', text: '提出创新想法推动进程', scores: { INTUITIVE: 2 } },
      { id: 'dec-q13-b', text: '提供数据支持或质疑假设', scores: { ANALYTICAL: 3 } },
      { id: 'dec-q13-c', text: '促进讨论，整合不同观点', scores: { CONSULTATIVE: 3 } },
      { id: 'dec-q13-d', text: '等待他人主导，自己跟随', scores: { DEPENDENT: 2, AVOIDANT: 1 } },
    ],
  },
  {
    id: 'dec-q14', testId: 'test-decision', order: 14,
    text: '你认为"错误的决策"意味着什么？',
    options: [
      { id: 'dec-q14-a', text: '是学习和调整的机会', scores: { INTUITIVE: 2, SPONTANEOUS: 1 } },
      { id: 'dec-q14-b', text: '分析不足，需要改进方法', scores: { ANALYTICAL: 3 } },
      { id: 'dec-q14-c', text: '可能没有充分听取意见', scores: { CONSULTATIVE: 2 } },
      { id: 'dec-q14-d', text: '证明做决定是危险的事', scores: { AVOIDANT: 3 } },
    ],
  },
  {
    id: 'dec-q15', testId: 'test-decision', order: 15,
    text: '回顾你过去的重要决定，你觉得...',
    options: [
      { id: 'dec-q15-a', text: '大多数时候直觉是对的', scores: { INTUITIVE: 3 } },
      { id: 'dec-q15-b', text: '经过分析的决定更可靠', scores: { ANALYTICAL: 3 } },
      { id: 'dec-q15-c', text: '他人的建议很有价值', scores: { CONSULTATIVE: 2 } },
      { id: 'dec-q15-d', text: '如果能少做决定就好了', scores: { AVOIDANT: 3 } },
    ],
  },
];
...
export const decisionResults = [
  {
    ...
    typeName: '直觉型',
    summary: '相信直觉，快速决策',
    description: '你相信自己的直觉，能在信息不足时快速做出决定。你擅长捕捉稍纵即逝的机会，不纠结于细节分析。你的决策风格灵活敏捷，适合快节奏的环境。',
    strengths: ['决策快速果断', '善于把握时机', '适应变化能力强', '行动力强'],
    weaknesses: ['可能过于冲动', '有时忽略重要数据', '可能判断失误'],
    relationships: '在团队中，你常是推动者，但要注意听取他人意见。',
    career: '适合需要快速反应的工作：创业、投资、危机处理、销售。',
    growth: '重大决定前，也看看数据支持；小事继续相信直觉。',
    minScore: 0, maxScore: 100,
  },
  {
    ...
    typeName: '分析型',
    summary: '基于数据，深思熟虑',
    description: '你依赖数据和逻辑分析，追求最优解。你会花时间研究各种可能性，力求做出最理性的选择。你的决策质量高，可靠性强。',
    strengths: ['决策质量高', '逻辑清晰严谨', '减少决策错误', '善于风险评估'],
    weaknesses: ['决策时间较长', '可能过度分析', '有时错失时机'],
    relationships: '你是值得信赖的决策顾问，但要注意不要让他人等待太久。',
    career: '适合需要深度分析的工作：研究、风控、战略规划、咨询。',
    growth: '有时接受"足够好"的决定；效率也是一种质量。',
    minScore: 0, maxScore: 100,
  },
  {
    ...
    typeName: '咨询型',
    summary: '征求意见，集体决策',
    description: '你善于听取多方意见，通过讨论达成决策。你重视团队共识，善于整合不同观点。你的决策容易被接受，执行阻力小。',
    strengths: ['决策有支持', '考虑全面', '善于建立共识', '关系维护好'],
    weaknesses: ['可能效率低', '有时难以整合不同意见', '决策周期长'],
    relationships: '你是团队协调者，善于化解分歧，推动集体决策。',
    career: '适合需要协调沟通的工作：管理、人力资源、项目管理、调解。',
    growth: '紧急情况时，也需要独立快速做出决定。',
    minScore: 0, maxScore: 100,
  },
  {
    ...
    typeName: '回避型',
    summary: '拖延决策，避免责任',
    description: '你倾向于推迟或回避做决定，担心做错选择。你可能感到决策压力很大，希望有人能替你决定。这可能导致问题积累。',
    strengths: ['谨慎小心', '给自己更多时间', '避免冲动决定'],
    weaknesses: ['容易错失机会', '压力积累', '问题拖延', '影响他人'],
    relationships: '你可能在关系中让步过多，需要学习表达自己的选择。',
    career: '需要选择决策压力较小的环境，或有明确流程指引的工作。',
    growth: '从小决定开始练习，建立决策信心；相信没有完美选择。',
    minScore: 0, maxScore: 100,
  },
  {
    id: 'dec-spontaneous', testId: 'test-decision', typeCode: 'SPONTANEOUS',
    typeName: '自发型',
    summary: '随心而动，拥抱未知',
    description: '你喜欢随性决策，不追求过多规划。你认为计划赶不上变化，更愿意顺其自然。你能在不确定中找到乐趣。',
    strengths: ['灵活应变', '享受过程', '不受束缚', '富有冒险精神'],
    weaknesses: ['可能缺乏长远规划', '有时显得随意', '可能忽略后果'],
    relationships: '你让关系保持新鲜感，但也要给他人安全感。',
    career: '适合创意类、自由职业、需要即兴发挥的工作。',
    growth: '重要事情需要一些计划；不是所有事情都能即兴。',
    minScore: 0, maxScore: 100,
  },
  {
    id: 'dec-dependent', testId: 'test-decision', typeCode: 'DEPENDENT',
    typeName: '依赖型',
    summary: '依靠他人，寻求指引',
    description: '你倾向于依赖他人来做决定，可能缺乏决策信心。你习惯寻求权威或信任的人的确认，难以独立做选择。',
    strengths: ['尊重他人意见', '不固执己见', '善于配合'],
    weaknesses: ['缺乏独立性', '容易被影响', '难以承担责任'],
    relationships: '你可能是很好的跟随者，但要学会表达自己的需求。',
    career: '适合有清晰指导和流程的工作环境。',
    growth: '从小事开始独立决定，建立对判断力的信任。',
    minScore: 0, maxScore: 100,
  },
  {
    id: 'dec-deliberate', testId: 'test-decision', typeCode: 'DELIBERATE',
    typeName: '谨慎型',
    summary: '深思熟虑，步步为营',
    description: '你做决定时非常谨慎，会反复权衡各种可能性。你追求稳妥，不愿冒险，确保每一步都考虑周全。',
    strengths: ['决策稳妥', '风险意识强', '深思熟虑', '减少后悔'],
    weaknesses: ['可能过于保守', '错失风险机会', '决策周期长'],
    relationships: '你给人可靠感，但有时显得不够果断。',
    career: '适合需要谨慎决策的工作：财务、合规、质量管理。',
    growth: '有时需要勇敢迈出一步；并非所有风险都是坏事。',
    minScore: 0, maxScore: 100,
  },
];
...
export const enneagramQuestions = [
  { id: 'enn-q1', testId: 'test-enneagram', order: 1, text: '我最渴望的是...', options: [
    { id: 'enn-q1-1', text: '做到完美，不出错误', scores: { TYPE1: 3 } },
    { id: 'enn-q1-2', text: '被爱，被需要', scores: { TYPE2: 3 } },
    { id: 'enn-q1-3', text: '成功，被认可', scores: { TYPE3: 3 } },
    { id: 'enn-q1-4', text: '独特，真实地做自己', scores: { TYPE4: 3 } },
    { id: 'enn-q1-5', text: '理解世界，掌握知识', scores: { TYPE5: 3 } },
    { id: 'enn-q1-6', text: '安全，确定的事物', scores: { TYPE6: 3 } },
    { id: 'enn-q1-7', text: '快乐，自由，新奇体验', scores: { TYPE7: 3 } },
    { id: 'enn-q1-8', text: '力量，控制，公正', scores: { TYPE8: 3 } },
    { id: 'enn-q1-9', text: '和平，和谐，舒适', scores: { TYPE9: 3 } },
  ]},
  { id: 'enn-q2', testId: 'test-enneagram', order: 2, text: '我最大的恐惧是...', options: [
    { id: 'enn-q2-1', text: '做错事，有缺陷', scores: { TYPE1: 3 } },
    { id: 'enn-q2-2', text: '不被需要，不被爱', scores: { TYPE2: 3 } },
    { id: 'enn-q2-3', text: '失败，没有价值', scores: { TYPE3: 3 } },
    { id: 'enn-q2-4', text: '平凡，没有独特性', scores: { TYPE4: 3 } },
    { id: 'enn-q2-5', text: '无能，被侵入', scores: { TYPE5: 3 } },
    { id: 'enn-q2-6', text: '不确定，被抛弃', scores: { TYPE6: 3 } },
    { id: 'enn-q2-7', text: '受限，痛苦，无聊', scores: { TYPE7: 3 } },
    { id: 'enn-q2-8', text: '软弱，被控制', scores: { TYPE8: 3 } },
    { id: 'enn-q2-9', text: '冲突，分离', scores: { TYPE9: 3 } },
  ]},
  { id: 'enn-q3', testId: 'test-enneagram', order: 3, text: '在压力下，我会...', options: [
    { id: 'enn-q3-1', text: '更加严格，批评自己和他人', scores: { TYPE1: 3 } },
    { id: 'enn-q3-2', text: '更加付出，甚至过度帮助', scores: { TYPE2: 3 } },
    { id: 'enn-q3-3', text: '更努力工作，追求效率', scores: { TYPE3: 3 } },
    { id: 'enn-q3-4', text: '退缩，沉浸在情绪中', scores: { TYPE4: 3 } },
    { id: 'enn-q3-5', text: '撤退，需要独处思考', scores: { TYPE5: 3 } },
    { id: 'enn-q3-6', text: '焦虑，寻求确定性和支持', scores: { TYPE6: 3 } },
    { id: 'enn-q3-7', text: '逃避，寻求分心和娱乐', scores: { TYPE7: 3 } },
    { id: 'enn-q3-8', text: '掌控，更加直接和强硬', scores: { TYPE8: 3 } },
    { id: 'enn-q3-9', text: '麻木，拖延或逃避', scores: { TYPE9: 3 } },
  ]},
  { id: 'enn-q4', testId: 'test-enneagram', order: 4, text: '我认为成功意味着...', options: [
    { id: 'enn-q4-1', text: '做到最好，没有遗憾', scores: { TYPE1: 3 } },
    { id: 'enn-q4-2', text: '拥有深厚的人际关系', scores: { TYPE2: 3 } },
    { id: 'enn-q4-3', text: '达成目标，获得认可', scores: { TYPE3: 3 } },
    { id: 'enn-q4-4', text: '真实地表达自己', scores: { TYPE4: 3 } },
    { id: 'enn-q4-5', text: '深刻理解某些领域', scores: { TYPE5: 3 } },
    { id: 'enn-q4-6', text: '找到可靠的安全感', scores: { TYPE6: 3 } },
    { id: 'enn-q4-7', text: '体验丰富，充满快乐', scores: { TYPE7: 3 } },
    { id: 'enn-q4-8', text: '有影响力，被尊重', scores: { TYPE8: 3 } },
    { id: 'enn-q4-9', text: '内心平静，生活和谐', scores: { TYPE9: 3 } },
  ]},
  { id: 'enn-q5', testId: 'test-enneagram', order: 5, text: '别人可能这样评价我...', options: [
    { id: 'enn-q5-1', text: '标准高，有时过于严格', scores: { TYPE1: 3 } },
    { id: 'enn-q5-2', text: '热心，有时干涉他人', scores: { TYPE2: 3 } },
    { id: 'enn-q5-3', text: '高效，有时过于注重形象', scores: { TYPE3: 3 } },
    { id: 'enn-q5-4', text: '独特，有时过于情绪化', scores: { TYPE4: 3 } },
    { id: 'enn-q5-5', text: '智慧，有时过于疏离', scores: { TYPE5: 3 } },
    { id: 'enn-q5-6', text: '忠诚，有时过于焦虑', scores: { TYPE6: 3 } },
    { id: 'enn-q5-7', text: '有趣，有时不够专注', scores: { TYPE7: 3 } },
    { id: 'enn-q5-8', text: '有魄力，有时过于强势', scores: { TYPE8: 3 } },
    { id: 'enn-q5-9', text: '随和，有时不够主动', scores: { TYPE9: 3 } },
  ]},
  { id: 'enn-q6', testId: 'test-enneagram', order: 6, text: '我在团队中通常是...', options: [
    { id: 'enn-q6-1', text: '质量控制者，指出问题', scores: { TYPE1: 3 } },
    { id: 'enn-q6-2', text: '支持者，照顾他人需求', scores: { TYPE2: 3 } },
    { id: 'enn-q6-3', text: '执行者，推动目标达成', scores: { TYPE3: 3 } },
    { id: 'enn-q6-4', text: '创意者，提供独特视角', scores: { TYPE4: 3 } },
    { id: 'enn-q6-5', text: '分析者，提供深度见解', scores: { TYPE5: 3 } },
    { id: 'enn-q6-6', text: '忠实成员，尽职尽责', scores: { TYPE6: 3 } },
    { id: 'enn-q6-7', text: '活跃气氛者，带来活力', scores: { TYPE7: 3 } },
    { id: 'enn-q6-8', text: '领导者，做决策', scores: { TYPE8: 3 } },
    { id: 'enn-q6-9', text: '调解者，维持和谐', scores: { TYPE9: 3 } },
  ]},
  { id: 'enn-q7', testId: 'test-enneagram', order: 7, text: '面对冲突时，我会...', options: [
    { id: 'enn-q7-1', text: '坚持正确的方式', scores: { TYPE1: 3 } },
    { id: 'enn-q7-2', text: '试图理解各方，维护关系', scores: { TYPE2: 3 } },
    { id: 'enn-q7-3', text: '快速解决，继续前进', scores: { TYPE3: 3 } },
    { id: 'enn-q7-4', text: '感到受伤，可能退缩', scores: { TYPE4: 3 } },
    { id: 'enn-q7-5', text: '退后观察，理性分析', scores: { TYPE5: 3 } },
    { id: 'enn-q7-6', text: '担心后果，寻求安全', scores: { TYPE6: 3 } },
    { id: 'enn-q7-7', text: '转移话题或幽默化解', scores: { TYPE7: 3 } },
    { id: 'enn-q7-8', text: '直接面对，讲清楚', scores: { TYPE8: 3 } },
    { id: 'enn-q7-9', text: '尽量避免或淡化', scores: { TYPE9: 3 } },
  ]},
  { id: 'enn-q8', testId: 'test-enneagram', order: 8, text: '我看待生活的态度是...', options: [
    { id: 'enn-q8-1', text: '需要不断改进和完善', scores: { TYPE1: 3 } },
    { id: 'enn-q8-2', text: '关于爱与被爱', scores: { TYPE2: 3 } },
    { id: 'enn-q8-3', text: '是实现目标的过程', scores: { TYPE3: 3 } },
    { id: 'enn-q8-4', text: '寻找独特意义的旅程', scores: { TYPE4: 3 } },
    { id: 'enn-q8-5', text: '需要理解的现象', scores: { TYPE5: 3 } },
    { id: 'enn-q8-6', text: '充满不确定性', scores: { TYPE6: 3 } },
    { id: 'enn-q8-7', text: '应该享受和探索', scores: { TYPE7: 3 } },
    { id: 'enn-q8-8', text: '需要主动掌控', scores: { TYPE8: 3 } },
    { id: 'enn-q8-9', text: '追求平静与和谐', scores: { TYPE9: 3 } },
  ]},
  { id: 'enn-q9', testId: 'test-enneagram', order: 9, text: '我做决定时，最看重...', options: [
    { id: 'enn-q9-1', text: '是否符合标准原则', scores: { TYPE1: 3 } },
    { id: 'enn-q9-2', text: '对他人的影响', scores: { TYPE2: 3 } },
    { id: 'enn-q9-3', text: '效率和成果', scores: { TYPE3: 3 } },
    { id: 'enn-q9-4', text: '是否忠于真实感受', scores: { TYPE4: 3 } },
    { id: 'enn-q9-5', text: '是否有足够信息', scores: { TYPE5: 3 } },
    { id: 'enn-q9-6', text: '是否安全可靠', scores: { TYPE6: 3 } },
    { id: 'enn-q9-7', text: '是否有趣或有新意', scores: { TYPE7: 3 } },
    { id: 'enn-q9-8', text: '是否公正合理', scores: { TYPE8: 3 } },
    { id: 'enn-q9-9', text: '能否维持和谐', scores: { TYPE9: 3 } },
  ]},
];

export const enneagramResults = [
  { id: 'enn-1', testId: 'test-enneagram', typeCode: 'TYPE1', typeName: '完美型',
    summary: '追求完美，有明确的原则和标准',
    description: '你是一号人格——完美型。你有强烈的是非观念，追求完美和正确。你自律、负责，但有时过于苛求自己和他人。',
    strengths: ['有原则', '负责任', '追求卓越', '自律'],
    weaknesses: ['过于严格', '难以接受错误', '可能过于批评'],
    relationships: '在关系中你是可靠的，但需要学习接受不完美。',
    career: '适合需要精确和标准的工作：审计、法律、教育。',
    growth: '学会接受不完美，错误是成长的一部分。',
    minScore: 0, maxScore: 100 },
  { id: 'enn-2', testId: 'test-enneagram', typeCode: 'TYPE2', typeName: '助人型',
    summary: '渴望被爱，通过帮助他人获得价值感',
    description: '你是二号人格——助人型。你关心他人，乐于付出，渴望被需要。你温暖、有同理心，但有时过度关注他人而忽略自己。',
    strengths: ['温暖', '有同理心', '乐于助人', '善于关怀'],
    weaknesses: ['可能过度付出', '忽略自身需求', '期待回报'],
    relationships: '你是温暖的支持者，但也要学会接受他人的帮助。',
    career: '适合服务性工作：护理、教育、咨询。',
    growth: '学会照顾自己的需求，你的价值不只在付出。',
    minScore: 0, maxScore: 100 },
  { id: 'enn-3', testId: 'test-enneagram', typeCode: 'TYPE3', typeName: '成就型',
    summary: '追求成功和认可，高效达成目标',
    description: '你是三号人格——成就型。你追求成功和认可，善于设定和达成目标。你高效、自信，但有时过于关注外在形象。',
    strengths: ['高效', '目标导向', '适应力强', '有动力'],
    weaknesses: ['可能过于注重形象', '忽视真实感受', '害怕失败'],
    relationships: '你是活跃的伴侣，但需要学习真实地表达情感。',
    career: '适合竞争性工作：销售、管理、创业。',
    growth: '成功不仅是外在成就，也是内在满足。',
    minScore: 0, maxScore: 100 },
  { id: 'enn-4', testId: 'test-enneagram', typeCode: 'TYPE4', typeName: '独特型',
    summary: '追求独特和真实，情感深刻丰富',
    description: '你是四号人格——独特型。你追求独特和真实，情感深刻丰富。你敏感、有创造力，但有时沉浸在情绪中。',
    strengths: ['有创造力', '敏感', '真实', '深刻'],
    weaknesses: ['可能过于情绪化', '感到被误解', '沉溺负面情绪'],
    relationships: '你渴望深度的情感连接，但也要学会接受平凡。',
    career: '适合创意工作：艺术、设计、写作。',
    growth: '你已经是独特的，不需要通过痛苦来证明。',
    minScore: 0, maxScore: 100 },
  { id: 'enn-5', testId: 'test-enneagram', typeCode: 'TYPE5', typeName: '观察型',
    summary: '追求理解，通过知识获得安全感',
    description: '你是五号人格——观察型。你渴望理解世界，通过知识获得安全感。你理性、独立，但有时过于疏离。',
    strengths: ['有洞察力', '理性', '独立', '知识渊博'],
    weaknesses: ['可能过于退缩', '情感表达困难', '难以行动'],
    relationships: '你需要独立空间，但也要学习分享和连接。',
    career: '适合分析性工作：研究、技术、学术。',
    growth: '知识需要实践，你可以在行动中学习。',
    minScore: 0, maxScore: 100 },
  { id: 'enn-6', testId: 'test-enneagram', typeCode: 'TYPE6', typeName: '忠诚型',
    summary: '追求安全，忠诚可靠但容易焦虑',
    description: '你是六号人格——忠诚型。你追求安全和确定性，对潜在风险敏感。你忠诚、负责，但有时过于焦虑。',
    strengths: ['忠诚', '负责', '有预见性', '可靠'],
    weaknesses: ['可能过于焦虑', '难以信任', '犹豫不决'],
    relationships: '你是可靠的伴侣，但要学会信任和放松。',
    career: '适合需要预见风险的工作：安全、质量、管理。',
    growth: '未来无法完全预知，相信自己的应对能力。',
    minScore: 0, maxScore: 100 },
  { id: 'enn-7', testId: 'test-enneagram', typeCode: 'TYPE7', typeName: '活跃型',
    summary: '追求快乐自由，害怕受限和痛苦',
    description: '你是七号人格——活跃型。你追求快乐和自由，热爱新奇体验。你乐观、有活力，但有时逃避负面情绪。',
    strengths: ['乐观', '有活力', '创意丰富', '适应力强'],
    weaknesses: ['可能逃避问题', '难以专注', '过度追求快乐'],
    relationships: '你带来欢乐，但也要学习面对困难。',
    career: '适合变化多的工作：市场、旅游、创意。',
    growth: '痛苦是生活的一部分，面对它会让快乐更真实。',
    minScore: 0, maxScore: 100 },
  { id: 'enn-8', testId: 'test-enneagram', typeCode: 'TYPE8', typeName: '领袖型',
    summary: '追求掌控和公正，直接而有力',
    description: '你是八号人格——领袖型。你追求力量和公正，愿意保护弱者。你果断、直接，但有时过于强势。',
    strengths: ['果断', '有魄力', '保护他人', '公正'],
    weaknesses: ['可能过于强势', '难以示弱', '可能冲突多'],
    relationships: '你是强有力的伴侣，也要学习柔软。',
    career: '适合领导性工作：管理、法律、创业。',
    growth: '柔软不是软弱，真正的力量包含温柔。',
    minScore: 0, maxScore: 100 },
  { id: 'enn-9', testId: 'test-enneagram', typeCode: 'TYPE9', typeName: '和平型',
    summary: '追求和谐平静，随和但可能逃避冲突',
    description: '你是九号人格——和平型。你追求和谐与平静，善于调解。你随和、包容，但有时过于被动。',
    strengths: ['随和', '包容', '有耐心', '善于调解'],
    weaknesses: ['可能过于被动', '逃避冲突', '难以做决定'],
    relationships: '你是令人舒适的伴侣，但也要表达自己的需求。',
    career: '适合需要协调的工作：人力资源、咨询、支持。',
    growth: '你的声音值得被听见，冲突也可以是建设性的。',
    minScore: 0, maxScore: 100 },
];

// ==== 职业倾向测试 ====
export const careerQuestions = [
  { id: 'career-q1', testId: 'test-career', order: 1, text: '工作中，你最享受的是...', options: [
    { id: 'career-q1-a', text: '解决技术难题，优化系统', scores: { TECHNICAL: 3 } },
    { id: 'career-q1-b', text: '与人交流，帮助他人', scores: { SOCIAL: 3 } },
    { id: 'career-q1-c', text: '创意表达，设计新事物', scores: { CREATIVE: 3 } },
    { id: 'career-q1-d', text: '组织管理，推动项目', scores: { MANAGERIAL: 3 } },
  ]},
  { id: 'career-q2', testId: 'test-career', order: 2, text: '面对一个新项目，你更倾向于...', options: [
    { id: 'career-q2-a', text: '深入研究细节和原理', scores: { TECHNICAL: 3 } },
    { id: 'career-q2-b', text: '考虑对他人的影响', scores: { SOCIAL: 2 } },
    { id: 'career-q2-c', text: '构思创新的解决方案', scores: { CREATIVE: 3 } },
    { id: 'career-q2-d', text: '制定计划和分工', scores: { MANAGERIAL: 3 } },
  ]},
  { id: 'career-q3', testId: 'test-career', order: 3, text: '你觉得最理想的工作环境是...', options: [
    { id: 'career-q3-a', text: '安静，可以专注研究', scores: { TECHNICAL: 2 } },
    { id: 'career-q3-b', text: '开放，可以与人互动', scores: { SOCIAL: 3 } },
    { id: 'career-q3-c', text: '灵活，允许自由表达', scores: { CREATIVE: 3 } },
    { id: 'career-q3-d', text: '有序，有清晰的目标和结构', scores: { MANAGERIAL: 2 } },
  ]},
  { id: 'career-q4', testId: 'test-career', order: 4, text: '在团队中，你更擅长...', options: [
    { id: 'career-q4-a', text: '提供技术解决方案', scores: { TECHNICAL: 3 } },
    { id: 'career-q4-b', text: '协调人际关系', scores: { SOCIAL: 2 } },
    { id: 'career-q4-c', text: '提出新想法和方向', scores: { CREATIVE: 3 } },
    { id: 'career-q4-d', text: '组织任务分配进度', scores: { MANAGERIAL: 3 } },
  ]},
  { id: 'career-q5', testId: 'test-career', order: 5, text: '你的空闲时间通常用来...', options: [
    { id: 'career-q5-a', text: '学习新技能或研究兴趣领域', scores: { TECHNICAL: 2 } },
    { id: 'career-q5-b', text: '社交活动或志愿服务', scores: { SOCIAL: 3 } },
    { id: 'career-q5-c', text: '艺术创作或欣赏', scores: { CREATIVE: 3 } },
    { id: 'career-q5-d', text: '规划个人目标或阅读管理书籍', scores: { MANAGERIAL: 2 } },
  ]},
  { id: 'career-q6', testId: 'test-career', order: 6, text: '面对变化，你通常会...', options: [
    { id: 'career-q6-a', text: '分析变化的技术影响', scores: { TECHNICAL: 2 } },
    { id: 'career-q6-b', text: '关心对人的影响', scores: { SOCIAL: 3 } },
    { id: 'career-q6-c', text: '看到创新机会', scores: { CREATIVE: 3 } },
    { id: 'career-q6-d', text: '制定应对策略', scores: { MANAGERIAL: 3 } },
  ]},
  { id: 'career-q7', testId: 'test-career', order: 7, text: '你最看重的工作回报是...', options: [
    { id: 'career-q7-a', text: '专业能力和认可', scores: { TECHNICAL: 3 } },
    { id: 'career-q7-b', text: '帮助他人的机会', scores: { SOCIAL: 3 } },
    { id: 'career-q7-c', text: '创造表达的满足', scores: { CREATIVE: 3 } },
    { id: 'career-q7-d', text: '事业成就和影响力', scores: { MANAGERIAL: 3 } },
  ]},
  { id: 'career-q8', testId: 'test-career', order: 8, text: '你更希望被评价为...', options: [
    { id: 'career-q8-a', text: '技术精湛的专家', scores: { TECHNICAL: 3 } },
    { id: 'career-q8-b', text: '值得信赖的伙伴', scores: { SOCIAL: 3 } },
    { id: 'career-q8-c', text: '有创意的思考者', scores: { CREATIVE: 3 } },
    { id: 'career-q8-d', text: '有效的领导者', scores: { MANAGERIAL: 3 } },
  ]},
];

export const careerResults = [
  { id: 'career-technical', testId: 'test-career', typeCode: 'TECHNICAL', typeName: '技术专家型',
    summary: '善于分析和解决技术问题，追求专业精进',
    description: '你适合技术专家型的职业方向。你善于分析和解决技术问题，喜欢深入研究和精进专业知识。',
    strengths: ['分析能力强', '专注深入', '解决问题', '持续学习'],
    weaknesses: ['可能忽视人际', '有时过于完美', '可能疏离团队'],
    relationships: '你可能更专注于工作本身，需要学习维护人际关系。',
    career: '适合技术性工作：工程师、研究员、分析师、医生等。',
    growth: '在精进专业的同时，也要培养软技能和人际网络。',
    minScore: 0, maxScore: 100 },
  { id: 'career-social', testId: 'test-career', typeCode: 'SOCIAL', typeName: '人际服务型',
    summary: '善于与人交往，乐于帮助他人',
    description: '你适合人际服务型的职业方向。你善于理解他人需求，乐于提供帮助和支持。',
    strengths: ['同理心强', '善于沟通', '关心他人', '有耐心'],
    weaknesses: ['可能忽略自己', '边界感不足', '情绪易受影响'],
    relationships: '你是好的倾听者和支持者，但也要学会保护自己。',
    career: '适合服务性工作：教育、护理、咨询、人力资源等。',
    growth: '你的付出很有价值，但也要学会照顾自己的需求。',
    minScore: 0, maxScore: 100 },
  { id: 'career-creative', testId: 'test-career', typeCode: 'CREATIVE', typeName: '创意表达型',
    summary: '善于创新和表达，追求独特和自由',
    description: '你适合创意表达型的职业方向。你有丰富的想象力和创造力，喜欢独特和自由的工作方式。',
    strengths: ['创意丰富', '善于表达', '有审美', '灵活'],
    weaknesses: ['可能不切实际', '难以接受约束', '情绪波动'],
    relationships: '你带来新鲜感和创意，但也要学习接受现实的约束。',
    career: '适合创意性工作：设计、艺术、广告、媒体、内容创作等。',
    growth: '创意需要落地，学习把想法转化为实际成果。',
    minScore: 0, maxScore: 100 },
  { id: 'career-managerial', testId: 'test-career', typeCode: 'MANAGERIAL', typeName: '管理领导型',
    summary: '善于组织和领导，追求成就和影响',
    description: '你适合管理领导型的职业方向。你善于制定计划、组织资源、推动项目达成目标。',
    strengths: ['有领导力', '善于组织', '决策果断', '目标导向'],
    weaknesses: ['可能过于强势', '忽视细节', '压力较大'],
    relationships: '你是可靠的领导者，但也要学习倾听和授权。',
    career: '适合管理性工作：管理、创业、项目管理、运营等。',
    growth: '领导不仅是决策，更是赋能他人成长。',
    minScore: 0, maxScore: 100 },
];

// ==== Philosophy Personality Test Data (PM16) ====
// 四个哲学维度：
// L/I (Logos/Intuition): 认知源头 - 理/悟
// W/F (Will/Flux): 存在姿态 - 行/观
// U/P (Universal/Personal): 价值归宿 - 群/独
// M/T (Material/Transcendental): 世界底色 - 实/灵

export const philosophyQuestions = [
  // 维度1: L/I - 认知源头
  { id: 'phil-q1', testId: 'test-philosophy-personality', order: 1, text: '面对一个复杂的问题，你更倾向于...', options: [
    { id: 'phil-q1-a', text: '收集数据、分析逻辑，找出最优解', scores: { L: 3 } },
    { id: 'phil-q1-b', text: '凭直觉感知，相信内心的声音', scores: { I: 3 } },
  ]},
  { id: 'phil-q2', testId: 'test-philosophy-personality', order: 2, text: '你觉得真理更多存在于...', options: [
    { id: 'phil-q2-a', text: '可被证明和验证的知识中', scores: { L: 3 } },
    { id: 'phil-q2-b', text: '超越语言的体验和顿悟中', scores: { I: 3 } },
  ]},
  { id: 'phil-q3', testId: 'test-philosophy-personality', order: 3, text: '当别人说"相信我，这是对的"时，你会...', options: [
    { id: 'phil-q3-a', text: '追问依据和证据', scores: { L: 2 } },
    { id: 'phil-q3-b', text: '感受对方的诚意和直觉', scores: { I: 2 } },
  ]},
  { id: 'phil-q4', testId: 'test-philosophy-personality', order: 4, text: '你更喜欢怎样的学习方式？', options: [
    { id: 'phil-q4-a', text: '系统学习理论框架和概念', scores: { L: 2 } },
    { id: 'phil-q4-b', text: '在实践中体悟和感受', scores: { I: 2 } },
  ]},

  // 维度2: W/F - 存在姿态
  { id: 'phil-q5', testId: 'test-philosophy-personality', order: 5, text: '面对不理想的环境，你更倾向于...', options: [
    { id: 'phil-q5-a', text: '主动改变，塑造自己想要的状态', scores: { W: 3 } },
    { id: 'phil-q5-b', text: '顺势而为，在变化中保持内心的平静', scores: { F: 3 } },
  ]},
  { id: 'phil-q6', testId: 'test-philosophy-personality', order: 6, text: '你觉得人生更像是一场...', options: [
    { id: 'phil-q6-a', text: '需要主动出击的战役', scores: { W: 3 } },
    { id: 'phil-q6-b', text: '值得静观其变的旅程', scores: { F: 3 } },
  ]},
  { id: 'phil-q7', testId: 'test-philosophy-personality', order: 7, text: '当你遇到困难时，第一反应是...', options: [
    { id: 'phil-q7-a', text: '我能做什么来改变现状', scores: { W: 2 } },
    { id: 'phil-q7-b', text: '这件事想告诉我什么', scores: { F: 2 } },
  ]},
  { id: 'phil-q8', testId: 'test-philosophy-personality', order: 8, text: '你更欣赏哪种人生态度？', options: [
    { id: 'phil-q8-a', text: '强者意志，不屈服于命运', scores: { W: 2 } },
    { id: 'phil-q8-b', text: '随遇而安，在流动中自洽', scores: { F: 2 } },
  ]},

  // 维度3: U/P - 价值归宿
  { id: 'phil-q9', testId: 'test-philosophy-personality', order: 9, text: '在做一个重要决定时，你会优先考虑...', options: [
    { id: 'phil-q9-a', text: '对他人的影响和集体的利益', scores: { U: 3 } },
    { id: 'phil-q9-b', text: '自己的内心真实和个人感受', scores: { P: 3 } },
  ]},
  { id: 'phil-q10', testId: 'test-philosophy-personality', order: 10, text: '你更认同哪种观点？', options: [
    { id: 'phil-q10-a', text: '个人的价值在于对社会的贡献', scores: { U: 3 } },
    { id: 'phil-q10-b', text: '每个人都是独一无二的存在', scores: { P: 3 } },
  ]},
  { id: 'phil-q11', testId: 'test-philosophy-personality', order: 11, text: '当个人利益与集体利益冲突时...', options: [
    { id: 'phil-q11-a', text: '我会牺牲一些个人利益', scores: { U: 2 } },
    { id: 'phil-q11-b', text: '我更看重个人的选择权', scores: { P: 2 } },
  ]},
  { id: 'phil-q12', testId: 'test-philosophy-personality', order: 12, text: '你认为人生的意义主要来自...', options: [
    { id: 'phil-q12-a', text: '与他人的连接和共同的使命', scores: { U: 2 } },
    { id: 'phil-q12-b', text: '探索自己独特的道路和真实', scores: { P: 2 } },
  ]},

  // 维度4: M/T - 世界底色
  { id: 'phil-q13', testId: 'test-philosophy-personality', order: 13, text: '你觉得这个世界的本质是...', options: [
    { id: 'phil-q13-a', text: '物质构成的，一切都可以被解释', scores: { M: 3 } },
    { id: 'phil-q13-b', text: '有超越表象的深层意义或神性', scores: { T: 3 } },
  ]},
  { id: 'phil-q14', testId: 'test-philosophy-personality', order: 14, text: '当你仰望星空时，你更多感到...', options: [
    { id: 'phil-q14-a', text: '对宇宙奥秘的好奇和敬畏', scores: { T: 2 } },
    { id: 'phil-q14-b', text: '对现实生活的珍惜和热爱', scores: { M: 2 } },
  ]},
  { id: 'phil-q15', testId: 'test-philosophy-personality', order: 15, text: '你相信...', options: [
    { id: 'phil-q15-a', text: '当下的生活就是存在的全部意义', scores: { M: 2 } },
    { id: 'phil-q15-b', text: '在物质之外还有更高的精神维度', scores: { T: 2 } },
  ]},
  { id: 'phil-q16', testId: 'test-philosophy-personality', order: 16, text: '面对死亡，你的态度更接近...', options: [
    { id: 'phil-q16-a', text: '坦然接受，这是生命自然的一部分', scores: { M: 2 } },
    { id: 'phil-q16-b', text: '相信某种形式的延续或超越', scores: { T: 2 } },
  ]},
];

// 16种哲学人格结果
export const philosophyResults = [
  // 第01组：理性建构组 (L-W-U-M/T)
  { id: 'phil-001', testId: 'test-philosophy-personality', typeCode: 'LWUM', typeName: '建构者', typeSubtitle: 'The Architect',
    summary: '你很难"随便活着"，混乱低效在你眼里是刺眼的Bug',
    description: '你习惯在脑子里画图纸，无论是一个项目还是一段人生，你都想用强执行力把它打造成最完美运转的机器。你能在废墟和混乱中迅速建立秩序，极度果断，绝不内耗。',
    strengths: ['降维打击的结构化思维', '极度果断', '迅速建立秩序', '执行力强'],
    weaknesses: ['对低效缺乏耐心', '掌控欲过载', '很难真正躺平'],
    relationships: '更像"解决问题的人"，而不是"提供情绪价值的人"。',
    career: '天生的操盘手或规则制定者，适合管理、架构设计、战略规划。',
    growth: '你不是不累，你只是无法容忍世界太失控。',
    minScore: 0, maxScore: 100 },
  { id: 'phil-002', testId: 'test-philosophy-personality', typeCode: 'LWUT', typeName: '立法者', typeSubtitle: 'The Legislator',
    summary: '你身上有种难得的"古典气"，极其自律，做事看"这事儿对不对"',
    description: '面对灰度地带你总是本能抗拒，宁可自己吃点亏，也不愿意弄脏自己的羽毛。道德底线极高，让人天然信任，具有不怒自威的原则感。',
    strengths: ['极其靠谱', '道德底线高', '人格魅力', '值得信赖'],
    weaknesses: ['精神洁癖太重', '容易碰壁', '因别人没底线而内伤'],
    relationships: '忠诚度极高，但对伴侣的道德要求同样苛刻。',
    career: '最硬的骨头，不站队只认理，适合法律、合规、审计。',
    growth: '水至清则无鱼，你用圣人的标准要求自己，却总被凡人重伤。',
    minScore: 0, maxScore: 100 },
  { id: 'phil-003', testId: 'test-philosophy-personality', typeCode: 'LWPM', typeName: '超人', typeSubtitle: 'The Übermensch',
    summary: '你最讨厌听到"大家都这样"，骨子里有极度的好胜心和慕强心理',
    description: '你把生活当成不断升级的闯关游戏，别人的评价对你毫无意义，你只在乎今天是否比昨天更强大、更自由。拥有强悍的抗挫折能力，越挫越勇。',
    strengths: ['抗挫折能力极强', '目标明确', '敢于打破陈规', '结果导向'],
    weaknesses: ['容易显得傲慢', '难建立脆弱交托的关系', '可能断崖式崩盘'],
    relationships: '需要势均力敌的战友，受不了黏糊糊的依恋。',
    career: '极具攻击性的开拓者，适合创业、投资、竞争性行业。',
    growth: '你赢了所有人，但深夜里连一个可以暴露软弱的人都没有。',
    minScore: 0, maxScore: 100 },
  { id: 'phil-004', testId: 'test-philosophy-personality', typeCode: 'LWPT', typeName: '神学者', typeSubtitle: 'The Theologian',
    summary: '你是个矛盾体：聪明逻辑缜密，却总觉得升职加薪"差点意思"',
    description: '你总是在深夜思考那些没有答案的问题：我是谁？这一切有什么意义？你试图用最高级的理智，去找一个精神寄托。深邃的洞察力让你能看到事物最核心的本质。',
    strengths: ['上帝视角看问题', '深邃洞察力', '精神韧性强'],
    weaknesses: ['容易虚无感', '俗世格格不入', '想太多做太少'],
    relationships: '灵魂伴侣的极致追求者，找不到宁可孤独。',
    career: '大智若愚，适合研究、哲学、神学、深度内容创作。',
    growth: '你算得出宇宙的规律，却算不出自己今晚为何失眠。',
    minScore: 0, maxScore: 100 },

  // 第02组：冷静观察组 (L-F-U-M/T)
  { id: 'phil-005', testId: 'test-philosophy-personality', typeCode: 'LFUM', typeName: '格物家', typeSubtitle: 'The Empiricist',
    summary: '你就像自带雷达的观察员，群体暗流你全看在眼里',
    description: '你极度务实，说话做事讲究证据和数据。画大饼没用，把眼前每件小事拆解明白才是最大的安全感。情绪超级稳定，泰山崩于前而色不变。',
    strengths: ['情绪超稳定', '信息收集能力强', '绝对靠谱', '现实主义'],
    weaknesses: ['显得冷漠无趣', '把情感当数学题解', '过于求稳'],
    relationships: '讲理多于讲情，擅长解决现实麻烦。',
    career: '不可或缺的业务骨干和风险把控者，适合数据、风控、审计。',
    growth: '你算准了所有利弊得失，却唯独漏算了心跳的感觉。',
    minScore: 0, maxScore: 100 },
  { id: 'phil-006', testId: 'test-philosophy-personality', typeCode: 'LFUT', typeName: '辩证者', typeSubtitle: 'The Dialectician',
    summary: '你总觉得世界"不够完美"，有极高的心智水平和审美要求',
    description: '你喜欢和聪明人聊天，热衷探讨深刻话题。但回到柴米油盐就感到厌倦，恨不得缩回精神洞穴。审美品味极佳，能迅速看透底层逻辑。',
    strengths: ['审美极佳', '看透底层逻辑', '思想启蒙者'],
    weaknesses: ['眼高手低', '严重拖延症', '对凡俗生活不耐烦'],
    relationships: '期待极高，对方一旦露出平庸之态就想后退。',
    career: '更适合做战略智囊而非落地执行，适合咨询、策划。',
    growth: '你在脑海里过完了完美的一生，现实中却连个钉子都没敲。',
    minScore: 0, maxScore: 100 },
  { id: 'phil-007', testId: 'test-philosophy-personality', typeCode: 'LFPM', typeName: '怀疑者', typeSubtitle: 'The Skeptic',
    summary: '你有一双看透一切的"冷眼"，任何鸡汤都会被瞬间拆解',
    description: '你从不迷信权威，甚至连自己都怀疑。你极其独立，认为人生不过是充满偶然的体验。活得异常通透，没有沉重的思想包袱。',
    strengths: ['免疫所有忽悠', '遇事极其冷静', '活得通透'],
    weaknesses: ['容易虚无主义', '很难纯粹狂喜', '显得刻薄'],
    relationships: '需要极大私人空间，最讨厌被粘着。',
    career: '犀利的纠错者，适合批评、审核、独立研究。',
    growth: '你看透了一切，但你快乐吗？',
    minScore: 0, maxScore: 100 },
  { id: 'phil-008', testId: 'test-philosophy-personality', typeCode: 'LFPT', typeName: '静观者', typeSubtitle: 'The Observer',
    summary: '朋友觉得你是个"老灵魂"，面对起落有种"这都是必然"的超然感',
    description: '你不喜欢与人争辩，因为你觉得大家不在一个维度。你享受极致的孤独并在孤独中自足。精神内耗极低，自带隔绝焦虑的结界。',
    strengths: ['精神内耗低', '包容度高', '一眼看透结局'],
    weaknesses: ['缺乏世俗野心', '情感反馈弱', '容易孤僻'],
    relationships: '像温柔的黑洞，什么都吸纳但什么都不回应。',
    career: '不管闲事，适合独立研究、写作、艺术创作。',
    growth: '你以为自己是超脱，其实你只是在逃避做真人的痛苦。',
    minScore: 0, maxScore: 100 },

  // 第03组：直觉行动组 (I-W-U-M/T)
  { id: 'phil-009', testId: 'test-philosophy-personality', typeCode: 'IWUM', typeName: '革命家', typeSubtitle: 'The Revolutionary',
    summary: '你永远闲不住，极度厌恶死气沉沉的环境',
    description: '比起做计划，你更相信直觉和一腔热血。你具有极强的感染力，只要认准一件事，就能用激情把周围的人全点燃，哪怕这意味着要掀翻现有的桌子。',
    strengths: ['恐怖的执行力', '天生的领袖魅力', '不怕失败'],
    weaknesses: ['三分钟热度', '容易冲动', '极速消耗自己'],
    relationships: '爱憎分明，轰轰烈烈，经常相爱相杀。',
    career: '冲锋陷阵的尖刀连，极佳的初创团队核心。',
    growth: '你砸烂了旧世界，但你建不起一个新家。',
    minScore: 0, maxScore: 100 },
  { id: 'phil-010', testId: 'test-philosophy-personality', typeCode: 'IWUT', typeName: '先知', typeSubtitle: 'The Prophet',
    summary: '你有一颗极其柔软敏感的心，能体会到新闻背后的眼泪',
    description: '你觉得身上有莫名的责任感，想去帮助别人，想让世界变好。为了你在乎的信念，你甚至愿意牺牲自己的利益，是个名副其实的操心命。',
    strengths: ['敏锐共情力', '道德感高', '利他精神'],
    weaknesses: ['救世主情结', '极度内耗', '不懂拒绝'],
    relationships: '付出型人格，总是委屈自己成全对方。',
    career: '团队里的知心人，适合教育、公益、心理咨询。',
    growth: '你度了所有人，唯独忘了放过你自己。',
    minScore: 0, maxScore: 100 },
  { id: 'phil-011', testId: 'test-philosophy-personality', typeCode: 'IWPM', typeName: '荒诞英雄', typeSubtitle: 'The Absurdist',
    summary: '你是一个很酷的现实主义者，早就看透了生活没啥意义',
    description: '但你偏偏不认怂。你觉得"来都来了"，索性痛痛快快活一场。你不信命不信大道理，只相信此刻流下的汗和对抗操蛋生活的快感。',
    strengths: ['强大逆商', '活得真实生猛', '野蛮生长'],
    weaknesses: ['容易虚无', '自我毁灭倾向', '难以相信持久'],
    relationships: '烈火烹油，不求天长地久只求曾经拥有。',
    career: '抗压能力最强，专打逆风局，适合危机公关。',
    growth: '你每天都在跟生活搏斗，却不知道自己到底想赢什么。',
    minScore: 0, maxScore: 100 },
  { id: 'phil-012', testId: 'test-philosophy-personality', typeCode: 'IWPT', typeName: '信仰骑士', typeSubtitle: 'The Knight of Faith',
    summary: '你是为了心中热爱可以倾其所有的狠人，极其相信直觉',
    description: '在别人看来不可理喻的冒险，在你眼里是命中注定的必由之路。你讨厌按部就班的安全感，更愿意为了虚无缥缈的理想，朝着未知深渊闭眼纵身一跃。',
    strengths: ['极致纯粹', '胆大包天', '直觉精准'],
    weaknesses: ['一战封神或粉身碎骨', '容易决裂', '缺乏安全感'],
    relationships: '要么一生一世，要么老死不相往来。',
    career: '无法被管理的刺头，只为懂自己的伯乐卖命。',
    growth: '你为了天上的月亮倾其所有，却饿死在去买面包的路上。',
    minScore: 0, maxScore: 100 },

  // 第04组：灵性流浪组 (I-F-U-M/T)
  { id: 'phil-013', testId: 'test-philosophy-personality', typeCode: 'IFUM', typeName: '同情者', typeSubtitle: 'The Sympathizer',
    summary: '你有一双看透世俗痛苦的眼睛，不喜欢争抢',
    description: '你觉得名利到头来都是一场空，身上带着淡淡的忧郁气质，对艺术或哲学有天然亲近感。你宁愿躲进精神避难所，也不愿面对外面的倾轧和算计。',
    strengths: ['艺术天赋', '深度倾听', '脾气温和'],
    weaknesses: ['极度敏感', '回避型倾向', '缺乏改变勇气'],
    relationships: '极其细腻敏感，容易在感情中受尽委屈。',
    career: '默默无闻的执行者，适合艺术、创作、助人行业。',
    growth: '你可怜了全天下，唯独忘了自己其实也有资格去争取。',
    minScore: 0, maxScore: 100 },
  { id: 'phil-014', testId: 'test-philosophy-personality', typeCode: 'IFUT', typeName: '曼陀罗', typeSubtitle: 'The Mandala',
    summary: '你在人群中有奇妙的"稳定器"效应，很少大喜大悲',
    description: '你有"看山还是山"的通透感。朋友有天大烦恼，到你这里聊几句也就释然了。你不跟人卷，也不评判，在柴米油盐里找到浑然天成的自洽。',
    strengths: ['精神内核稳定', '极具包容性', '直觉智慧'],
    weaknesses: ['显得不上进', '主动弃权', '对世俗乏味'],
    relationships: '提供极高安全感，但偶尔让人觉得缺乏激情。',
    career: '极其佛系的隐藏大佬，适合调解、咨询、艺术。',
    growth: '你原谅了全世界的平庸，却可能连自己真正想要什么都忘了。',
    minScore: 0, maxScore: 100 },
  { id: 'phil-015', testId: 'test-philosophy-personality', typeCode: 'IFPM', typeName: '流浪者', typeSubtitle: 'The Cynic',
    summary: '你是那种让人既看不惯又暗自羡慕的人',
    description: '你极度讨厌装腔作势，什么人情世故社会时钟，你统统不care。只要你有口饭吃有个地方睡觉，你就觉得老子天下第一。追求绝对的随心所欲。',
    strengths: ['绝对不内耗', '环境适应力强', '极其潇洒'],
    weaknesses: ['搞砸世俗积累', '不靠谱', '容易颓废'],
    relationships: '需要绝对空间，一被束缚就想逃跑。',
    career: '最讨厌打卡开会，适合自由职业、创作、冒险行业。',
    growth: '你以为你在反抗规则，其实你只是在逃避承担责任的苦。',
    minScore: 0, maxScore: 100 },
  { id: 'phil-016', testId: 'test-philosophy-personality', typeCode: 'IFPT', typeName: '逍遥客', typeSubtitle: 'The Wanderer',
    summary: '你是一个极其空灵的存在，好像从来没被物质世界困住过',
    description: '你的脑洞极大，灵感极其丰富，常在发呆时畅游宇宙。别人为一地鸡毛争吵，你却觉得好笑。你追求完全不受羁绊的灵魂自由，像一阵风，抓不住也留不下。',
    strengths: ['非凡想象力', '空灵洒脱', '精神高潮'],
    weaknesses: ['缺乏落地能力', '极不靠谱', '容易成为怪胎'],
    relationships: '像猫一样，靠近你是恩赐，远离你是常态。',
    career: '不适合坐班，只适合自由职业或创意工作。',
    growth: '你的灵魂在宇宙中翱翔，但肉身还在人间发愁下个月房租。',
    minScore: 0, maxScore: 100 },
];
